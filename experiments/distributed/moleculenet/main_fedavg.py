...
def add_args(parser):
    ...
    parser.add_argument('--data_dir', type=str, default='./../../../data/sider',
                        help='data directory')
...
def post_complete_message_to_sweep_process(args):
    ...
    if not os.path.exists(pipe_path):
        os.mkfifo(pipe_path) #이름있는 파이프를 만들자
...
if __name__ == "__main__":
    ...
    model, trainer = create_model(args, args.model, feat_dim, num_cats, output_dim=None) #공통의 글로벌 모델 생성할때 init 해준
